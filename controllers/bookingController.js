...
import { STRIPE_WEBHOOK_KEY } from "../config.js";
    ...
    line_items: [
      {
        price_data: {
          ...
          unit_amount: tour.price * 100 // Stripe requires smallest currency unit (e.g., cents for INR)
        },
        quantity: 1
      }
    ]
...
export const webhookCheckout = (req, res, next) => {
  ...
  let event;
  try {
    event = stripe.webhooks.constructEvent(req.body, signature, STRIPE_WEBHOOK_KEY);
  } catch (err) {
