...
},{"../dist/index.mjs":"../../node_modules/@stripe/stripe-js/dist/index.mjs"}],"../../config.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.STRIPE_WEBHOOK_KEY = exports.STRIPE_SECRET_KEY = exports.STRIPE_PUBLISHABLE_KEY = void 0;
var STRIPE_SECRET_KEY = exports.STRIPE_SECRET_KEY = "sk_test_51QL8G9ERyc3c5Kmv5dLXpj4TquesDnp26Wbpv7TTRJEETLrajQBolmcwNtqwOEt9Fsw6r3CQtFlBckrbPEPAPwrw00tWJNoDkK";
var STRIPE_PUBLISHABLE_KEY = exports.STRIPE_PUBLISHABLE_KEY = "pk_test_51QL8G9ERyc3c5Kmvv9ZbBx9kRHeqZlWTmT3wQKiV2KlAnoEM5Rww5twGp7ZccBAObbMsD8KO0lSNMrukLUZf8Pmj00hI40rMpd";
var STRIPE_WEBHOOK_KEY = exports.STRIPE_WEBHOOK_KEY = "whsec_8a4717691852656d2d16bb244a09f488221a23dc9893bc58a027ba3b77e1f146";
...
// Initialize Stripe
var stripePromise = (0, _stripeJs.loadStripe)(_config.STRIPE_PUBLISHABLE_KEY); // Replace with your actual public key
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          (0, _alerts.showAlert)("error", "Failed to retrieve session ID.");
        ...
        case 12:
          ...
          (0, _alerts.showAlert)("error", "Stripe failed to initialize.");
          return _context.abrupt("return");

        case 17:
          console.log("stripe", stripe); // 3) Redirect to Stripe Checkout
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","@stripe/stripe-js":"../../node_modules/@stripe/stripe-js/lib/index.mjs","../../config.js":"../../config.js"}],"index.js":[function(require,module,exports) {
"use strict";
